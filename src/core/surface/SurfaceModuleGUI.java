...
class SurfaceModuleGUI extends JPanel implements EventListener<SurfaceEvent> {
	 ...
	 */
	SurfaceModuleGUI(SurfaceModule sm) {
		super();
		initialize();
		surfMode = sm;
	...
	private void initialize() {
		...
		this.setSize(180, 375);
		this.setLayout(new GridBagLayout());
		this.setBorder(BorderFactory.createEmptyBorder(10, 10, 10, 10));
		this.setPreferredSize(new Dimension(180, 375));
